...
namespace ExaminationSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260716165547_AddCourseMaxEnrollment")]
    partial class AddCourseMaxEnrollment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.Exam", b =>
                {
                    ...
                    b.Property<int>("MaxDurationInMinutes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.ExamAttempt", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ExamAttemptStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.Tenant", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.TenantDomain", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.StudentExamsAnswers", b =>
                {
                    ...
                    b.HasOne("ExaminationSystem.Domain.Entities.ExamAttempt", "ExamAttempt")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("ExaminationSystem.Domain.Entities.TenantDomain", b =>
                {
                    b.HasOne("ExaminationSystem.Domain.Entities.Tenant", "Tenant")
                        .WithMany("Domains")
